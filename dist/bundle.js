...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Panel = __webpack_require__(300);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Panel = function () {
		function Panel(_ref) {
			...
			this.initEvents();
			this.initBackground();
			this.shapeRule['Rectangle'] = _Shape.Rectangle;
		}
		...
		_createClass(Panel, [{
			...
			value: function initEvents() {
				...
				this.frontCanvas.addEventListener('mousedown', function (e) {
					// 避免鼠标超出边界后回来，事件没有注销
					onmousemove && _this.frontCanvas.removeEventListener('mousemove', onmousemove);
					var startX = e.pageX,
					    startY = e.pageY;
					_this.menu.hide();
					// 由于层级覆盖，先检查上层的图形
					if (e.button === 0) {
						_this.findActiveShape(startX, startY, function (activedShape, activedDot) {
							...
							onmousemove = function onmousemove(e) {
								if (_this.drawLine && path) {
									path.close({ x: e.pageX - _this.offset.left, y: e.pageY - _this.offset.top });
									console.log(path);
									// path.draw();
								} else {
							...
							if (activedDot) {
								...
								activedDot.draw({ x: e.pageX - _this.offset.left, y: e.pageY - _this.offset.top });
								path = _this.addPath(_this.frontCtx, { x: e.pageX - _this.offset.left, y: e.pageY - _this.offset.top });
								path.close({ x: e.pageX - _this.offset.left, y: e.pageY - _this.offset.top });
			...
			value: function addShape(type) {
				...
				var shape = Reflect.construct(this.shapeRule[type], params);
			...
			value: function addPath() {
				...
				console.log(_Shape.Path, params);
				var path = Reflect.construct(_Shape.Path, params);
			...
			value: function importCanvasData(metaData) {
				...
				try {
					for (var _iterator4 = metaData[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
						var d = _step4.value;
...
/***/ function(module, exports) {
	...
	var Dot = function (_Shape2) {
		...
		function Dot(_ref3) {
			var x = _ref3.x,
			    ...
			    width = _ref3$width === undefined ? 8 : _ref3$width,
			    _ref3$height = _ref3.height,
			    height = _ref3$height === undefined ? 8 : _ref3$height,
		...
		_createClass(Dot, [{
			key: 'draw',
			value: function draw() {
				var position = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { x: this.position.x, y: this.position.y };
	...
	var Line = function Line(_ref4) {
		var x = _ref4.x,
		    y = _ref4.y,
		    canvasContext = _ref4.canvasContext;
	...
	var Path = exports.Path = function () {
		// lines为二元坐标的数组
		function Path(canvasContext) {
			_classCallCheck(this, Path);

			for (var _len = arguments.length, lines = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
				lines[_key - 1] = arguments[_key];
			}
		...
		_createClass(Path, [{
			...
			key: 'close',
			value: function close(_ref6) {
				var x = _ref6.x,
				    y = _ref6.y;

				if (this.lines.length > 2) {
					this.lines[this.lines.length - 1] = { x: x, y: y };
				} else {
			...
			value: function drawLine() {
				...
				try {
					for (var _iterator2 = this.lines.slice(1)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
						var l = _step2.value;
...
/***/ function(module, exports) {
	...
	var Menu = function () {
		function Menu(panel) {
			...
			this.options = [{ text: '连线', cb: this.drawLine, type: 1 }, { text: '复制', cb: this.copyShape, type: 1 }, { text: '粘贴', cb: this.pasteShape, type: 2 }, { text: '剪切', cb: this.cuteShape, type: 1 }, { text: '删除', cb: this.deleteShape, type: 1 }, { text: '保存为图片', cb: this.saveAsImage, type: 0 }].concat(_toConsumableArray(option));
		...
		_createClass(Menu, [{
			...
			key: 'drawLine',
			value: function drawLine(panel, activedShape) {
